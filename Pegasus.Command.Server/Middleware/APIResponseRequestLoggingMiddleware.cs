...
using Pegasus.Command.Server.Middleware.Extensions;
...
namespace Pegasus.Command.Server.Middleware
{
    ...
    public class APIResponseRequestLoggingMiddleware
    {
        ...
        public APIResponseRequestLoggingMiddleware(RequestDelegate next, bool enableAPILogging, IConfiguration configuration)
        {
            ...
            _ignorePaths = configuration.GetSection("Pegasus.Command:ApiLogging:IgnorePaths").Get<List<string>>();
        }
