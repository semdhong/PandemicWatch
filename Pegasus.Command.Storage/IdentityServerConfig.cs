...
using Pegasus.Command.Storage.Core;
using IdentityModel;
...
namespace Pegasus.Command.Storage
{
    ...
    {
        public const string ApiName = "Pegasus.Command_api";
        public const string ApiFriendlyName = "Pegasus.Command API";
        public const string AppClientID = "Pegasus.Command_spa";
        ...
        public static IEnumerable<IdentityServer4.Models.Client> GetClients()
        {
            ...
            return new List<IdentityServer4.Models.Client>
            {
                ...
                new IdentityServer4.Models.Client
                {
                    ...
                    ClientSecrets = new List<Secret> { new Secret { Value = "Pegasus.Command".Sha512() }},
                    Enabled = true,
